...
public class ManyToOneTest {
    ...
    void test1() {
        ...
        food2.setUser(user); // 외래키(연관 관계) 설정
    ...
    @Test
    @DisplayName("N대1 조회 : Food 기준 user 정보 조회 (단방향)")
    void test5() {
        // SQL : FK를 가지고 있는 테이블이 Food 이기 때문에, left join 사용하여 함께 조회
    ...
    @Test
    @DisplayName("N대1 조회 : User 기준 food 정보 조회 (양방향)")
    void test6() {
        // SQL : 테이블 각자 조회
